...
--yb_coff_dis 0 --yb_coff_loss 1 --yb_av 1 --yb_dual 1 --yb_factor_aduio 1 --yb_factor_audio_decay 0.1 --yb_audio_length 10 \
--pretrained_clip_name ViT-B/32  --wandb  1 --fixed_length 8 --model_name ECLIPSE_yc2_f32_B32 \
