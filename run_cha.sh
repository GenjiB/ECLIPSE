...
--lr 1e-4 --coef_lr 1e-3 --max_words 64 --max_frames 96 --max_audio_frames 32 \
--audio_cluster 4 --batch_size_val 16 --gradient_accumulation_steps 1 \
--datatype charades --feature_framerate 1  \
--freeze_layer_num 0  --slice_framepos 2 \
--loose_type --linear_patch 2d --sim_header meanP \
--yb_av 0 --yb_dual 0 --yb_factor_aduio 10 --yb_factor_audio_decay 0.8  --yb_audio_length 10 \
--pretrained_clip_name ViT-B/32  --wandb 1 --fixed_length 8 --model_name cha_baseline_96 \
