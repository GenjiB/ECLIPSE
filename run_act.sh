...
--lr 1e-4 --coef_lr 1e-3 --max_words 128 --max_frames 64 --max_audio_frames 2 \
...
--yb_audio_length 10 \
--pretrained_clip_name ViT-B/32  --wandb 1 --fixed_length 8 --model_name  CameraReady_ACT1.3_B16_baseline_64 \
