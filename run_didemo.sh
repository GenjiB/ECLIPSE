...
--lr 1e-4 --coef_lr 5e-3 --yb_factor_aduio 0.01 --yb_factor_audio_decay 0 --max_words 64 --max_frames 64 --max_audio_frames 2 --batch_size_val 16 \
--datatype didemo --feature_framerate 1  \
--freeze_layer_num 0  --slice_framepos 2 \
--loose_type --linear_patch 2d --sim_header meanP \
--yb_dual 0 --yb_av 0 --wandb 1 --model_name Rebuttal_didemo_B32_baseline_64 \
