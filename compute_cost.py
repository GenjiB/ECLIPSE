...
def get_args(description='CLIP4Clip on Retrieval Task'):
	...
	parser.add_argument("--yb_factor_1", default=1, type=float, help="test")
	parser.add_argument("--yb_factor_2", default=1, type=float, help="test")
